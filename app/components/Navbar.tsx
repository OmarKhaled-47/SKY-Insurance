...
//             <Image src="/logo.png" alt="Sky Insurance" width={75} height={75} />
//           </Link>
...
//               className={isScrolled ? "text-primary" : "text-black"}
//             >
...
function NavLink({
  ...
  return (
    <Link
      href={href}
      className={`${textColor} hover:text-blue-900 transition-colors relative`}
    >
      {children}
      {isActive && (
        <motion.span
